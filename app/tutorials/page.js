...
const AD_STUDIO_STEPS = [
  ...
  {
    title: 'Work Through the Output Tabs',
    icon: '📑',
    desc: 'Each tab builds on the previous. Angles → Hooks → Captions → Images → Video → UGC → Campaign → Music → Score → Launch → Calendar → A/B Tests → ROI → Inspire. Click "Use This" on any output to set it as the direction for everything that follows.',
    tips: [
      'Use This Angle and Use This Hook are the most important buttons — they connect everything',
      'The Campaign tab builds a 10-stage full funnel — cold awareness through winback',
      'Score tab rates your whole campaign across 8 dimensions before you spend money',
    ],
  },
  {
    title: 'Use the Intelligence Layer',
    icon: '🧠',
    desc: 'After every generation, the Creative Director AI fires automatically — showing what works, what is weak, and the exact next action. Lock your best outputs so they inject into every future generation. Star your best angles and hooks to build your Brand Brain.',
    tips: [
      'Lock button appears on angles, hooks, brand voice, visual style, and music',
      'Locked items show in the gold context bar at the top of every tab',
      'Brand Voice Fingerprint: paste 3 of your best ads and AI extracts your exact writing style',
    ],
  },
  {
    title: 'Add Music',
