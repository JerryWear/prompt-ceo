...
const TOOLS = [
  {
    ...
    icon:  '☀',
    label: 'Perfect Day™',
    sub:   '12-moment cinematic day',
    desc:  'A full content day — morning to midnight. 12 moments, 12 image prompts, 12 hooks.',
    color: C.gold,
    glow:  C.goldGlow,
  ...
  },
  {
    ...
    icon:  '◈',
    label: 'Full Campaign™',
    sub:   '5-phase ad funnel',
    desc:  'Attention → Story → Desire → Conversion → Retargeting. Complete 30-day campaign.',
    color: C.violet,
  ...
  },
  {
    ...
    icon:  '✦',
    label: 'Instant™',
    sub:   'AI-guided in 60 seconds',
    desc:  'Tell the AI what you want. Hooks, angles, captions, and image prompts — instantly.',
    color: C.green,
  ...
  },
  {
    ...
    icon:  '◧',
    label: 'Studio™',
    sub:   'Cinematic image generation',
    desc:  'Story worlds, identity system, visual direction, batch generation, shot director.',
    color: C.blue,
    glow:  C.blueGlow,
    path:  '/prompt-engine-v3',
    query: 'studio',
  },
  {
    ...
    icon:  '▣',
    label: 'Ad Studio™',
    sub:   'Hooks, angles & copy',
    desc:  'Build your full ad system. Hooks, angles, captions, video scripts, brand voice.',
    color: '#c87a4a',
