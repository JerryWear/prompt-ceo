export const WORLD_TOKYO = {
  ...
  sensoryPools: {
    wake: [
      ...
      'Aman Tokyo morning air — conditioned, still, and faintly cedar-scented above Otemachi',
    ],
    morning_refresh: [
      ...
      'the Aman deep soaking tub — dark stone, pale city light, and the city dissolving below',
    ],
    getting_dressed: [
      ...
      'the tactile pleasure of Japanese-engineered fabric as the Aman suite frames the Ginza day ahead',
    ],
    breakfast: [
      ...
      'Aman Tokyo in-suite breakfast — lacquer tray, white ceramic, dashi warmth above the Imperial Garden',
    ],
    late_morning: [
      ...
      'the polished stone and glass of Ginza Six — the apex of Tokyo retail sensory precision',
    ],
    lunch: [
      ...
      'Aoyama café midday — warm wood, white walls, and the world\'s most considered light through glass',
    ],
    afternoon: [
      ...
      'Senso-ji incense and stone — the oldest air in Tokyo, warm and ancient below paper lanterns',
    ],
    reset: [
      ...
      'Aman Tokyo suite in late afternoon — the deepest silence anywhere in the most electric city',
    ],
    golden_hour: [
      ...
      'Roppongi rooftop air at dusk — the full Tokyo grid warming amber, Tokyo Tower glowing first',
    ],
    dinner: [
      ...
      'the scent of dashi and yuzu at a Ginza counter — the first course of the best dinner on earth',
    ],
    evening: [
      ...
      'the particular electric warmth of Kabukicho at full activation — neon on skin, sound rising from everywhere',
    ],
    night: [
      ...
      'Aman Tokyo in the post-midnight quiet — linen, city glow, and Japanese stillness after Shinjuku',
    ],
  },
  ...
  atmospherePools: {
    wake: [
      ...
      'Aman Tokyo floor-to-ceiling glass holding the Imperial Garden still in pale grey light',
    ],
    morning_refresh: [
      ...
      'the Aman bathroom above Otemachi — the most deliberate private room in the city',
    ],
    getting_dressed: [
      ...
      'the focused quiet of choosing for Ginza from inside Aman\'s stillness',
    ],
    breakfast: [
      ...
      'the rare Tokyo hotel morning where the Imperial Garden is visible and nothing moves',
    ],
    late_morning: [
      ...
      'the clean competitive quiet of Ginza Six opening its floors to the day',
    ],
    lunch: [
      ...
      'Daikanyama at midday — the most literary and slow lunch atmosphere in the city',
    ],
    afternoon: [
      ...
      'Nakameguro canal in golden afternoon — the most beautiful urban walk on earth',
      'Senso-ji Asakusa in filtered afternoon light — the city\'s oldest air and incense warmth',
    ],
    reset: [
      ...
      'the Aman suite as transition space — the city transforming below while the room stays still',
    ],
    golden_hour: [
      ...
      'Roppongi rooftop with Tokyo Tower warming amber and Skytree beginning to glow',
    ],
    dinner: [
      ...
      'a Ginza kaiseki private room — paper screen glow, lacquer, and the first dark outside',
    ],
    evening: [
      ...
      'Kabukicho neon corridor as the most overwhelming and cinematic street in the world after dark',
    ],
    night: [
      ...
      'the Aman suite after Shinjuku — silence at altitude, the grid still glowing below through glass',
    ],
  },
  ...
  bodyLanguagePools: {
    wake: [
      ...
      'lying completely still in the Aman bed with the Imperial Garden pale below',
    ],
    morning_refresh: [
      ...
      'leaning lightly into the Aman bathroom mirror in clean morning city light',
    ],
    getting_dressed: [
      ...
      'tall composed mirror posture with the Otemachi grid dissolving behind',
    ],
    breakfast: [
      ...
      'seated at the Aman breakfast table with shoulders dropped and city below',
    ],
    late_morning: [
      ...
      'moving through Ginza Six with the easy authority of someone who belongs there',
    ],
    lunch: [
      ...
      'slight forward inclination at a Daikanyama table — entirely at ease in the world\'s finest lunch city',
    ],
    afternoon: [
      ...
      'pausing on the Nakameguro canal rail — one elbow resting, looking into the water below',
    ],
    reset: [
      ...
      'seated at the Aman suite window in the late afternoon with the city below settling into amber',
    ],
    golden_hour: [
      ...
      'standing at the Roppongi rooftop edge as Tokyo Tower lights gold and the grid begins electric',
    ],
    dinner: [
      ...
      'poised at the Ginza omakase counter — upright, still, watching the chef with total quiet attention',
    ],
    evening: [
      ...
      'pausing inside the Golden Gai alley with one shoulder against the lantern bar wall',
    ],
    night: [
      ...
      'back in the Aman suite — shoes off, the city glowing below, the body finally slow',
    ],
  },
  ...
  narrativeIntentPools: {
    wake: [
      ...
      'waking inside Aman Tokyo with the Imperial Garden still and grey-gold below',
    ],
    morning_refresh: [
      ...
      'the Aman bathroom as the first intentional space of the Tokyo day',
    ],
    getting_dressed: [
      ...
      'dressing above Otemachi before descending into the Ginza grid',
    ],
    breakfast: [
      ...
      'morning tea above the Imperial Garden before Ginza opens below',
    ],
    late_morning: [
      ...
      'letting Ginza Six and Aoyama reveal the day\'s first beautiful decisions',
    ],
    lunch: [
      ...
      'a Daikanyama table that makes the whole world slow down to Japanese pace',
    ],
    afternoon: [
      ...
      'the Nakameguro canal in autumn light as the most beautiful slow hour in Tokyo',
      'Yanaka\'s wooden lanes delivering the oldest and quietest version of the city',
    ],
    reset: [
      ...
      'the Aman suite as the still centre before Shinjuku pulls everything electric',
    ],
    golden_hour: [
      ...
      'watching the Roppongi rooftop turn the entire Tokyo grid amber before neon',
    ],
    dinner: [
      ...
      'the Ginza omakase counter as the most intimate and precise room in Japan',
    ],
    evening: [
      ...
      'Golden Gai lantern warmth as the human-scale secret inside the neon city',
    ],
    night: [
      ...
      'the Aman suite after midnight — the city still glowing below, the room entirely still',
    ],
  },
