...
import { buildCompetitorAnalysisPrompt } from '../../prompt-engine-v3/ad-system/competitorAnalysis.js'
...
export async function POST(req) {
  try {
    ...
    const { competitorText, adConfig } = await req.json()
    ...
    const userPrompt = buildCompetitorAnalysisPrompt(competitorText, adConfig || {})
