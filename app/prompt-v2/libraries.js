...
identity: [
  ...
  pose: [
    'not posing, unaware of camera, natural body positioning',
    'Natural standing pose, one hip slightly shifted, relaxed feminine posture, soft confident presence',
'Walking naturally through the scene, candid lifestyle movement, effortless confidence',
'Turning slightly toward camera, soft body angle, realistic casual movement',
'Leaning lightly against a surface, natural posture, relaxed feminine energy',
'Mid-step walking pose, caught-in-the-moment lifestyle realism',
'Adjusting hair casually, natural candid body posture, soft self-aware confidence',
'Light outfit adjustment, natural movement, realistic feminine presence',
'Looking into a mirror with subtle body angle, natural gym-girl confidence',
'Sitting casually with one leg slightly extended, relaxed lifestyle posture',
'Soft side-angle standing pose, natural waist emphasis, clean feminine silhouette',
'Resting one hand on hip, relaxed athletic confidence, not overly posed',
'Stretching lightly, natural body movement, realistic pre-workout energy',
'Walking past camera naturally, soft candid movement, modern influencer feel',
'Standing with weight mostly on one leg, relaxed torso, natural body line',
'Half-turned pose, gentle over-shoulder glance, realistic feminine confidence',
  ...
  moment: [
  'just finished a workout set, slightly out of breath, natural post-workout glow',
  'adjusting leggings casually between sets, relaxed focused energy',
  'checking herself in the mirror, subtle confidence, self-aware moment',
  'walking between machines, focused but relaxed gym energy',
  'resting briefly, hands on hips, steady breathing, natural posture',
  'stretching lightly after a set, soft body movement, relaxed focus',
  'fixing hair mid-workout, candid natural moment',
  'leaning on equipment, catching breath, realistic gym fatigue',
  'scrolling phone between sets, relaxed casual lifestyle moment',
  'tying hair up before next set, natural preparation moment',
],
  ...
  camera: [
'Handheld iPhone-style shot, slightly imperfect framing, natural perspective',
'Slightly tilted angle, imperfect composition, candid capture',
'Mid-action shot, slight motion blur, natural movement',
'Cropped unevenly, subject not centered, real-life framing',
'Shot through gym equipment, partial obstruction, realistic depth',
'Mirror selfie perspective, phone partially visible, casual framing',
'Walking shot, subject slightly blurred, candid lifestyle feel',
'Close-up with imperfect crop, not symmetrical, natural capture',
'Over-the-shoulder candid angle, partial subject visibility',
'Natural zoom variation, inconsistent framing, real-world feel',
