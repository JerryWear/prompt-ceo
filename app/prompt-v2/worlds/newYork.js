export const WORLD_NEW_YORK = {
  ...
  sensoryPools: {
    wake: [
      ...
      'the specific Tribeca loft morning sensation — grey city light through cast-iron frames, the street below still quiet',
      'cool glass against fingertips in a Midtown hotel suite with the whole still-grey Manhattan grid visible just beyond',
    ],
    morning_refresh: [
      ...
      'the sensation of a Tribeca loft shower in clear city morning light — every surface precise, the city outside still coming awake',
      'the specific focus of a Manhattan morning self-care moment — clean, minimal, the city beginning to hum below',
    ],
    getting_dressed: [
      ...
      'the weight and texture of well-chosen Manhattan fabric in a Tribeca loft dressing area with the city light behind',
      'the sensation of choosing the right editorial New York look above the grid — every decision sharper than it would be anywhere else',
    ],
    breakfast: [
      ...
      'the West Village café sensory world — coffee warm, cobblestone outside the glass, brownstone just beyond, the city not yet loud',
      'a Tribeca loft kitchen coffee in grey city morning — the cast-iron and industrial warmth, the street below just starting to move',
    ],
    late_morning: [
      ...
      'the SoHo late-morning sensory world — cool cast-iron shadow, Prince Street pavement, the art world faintly present around',
      'Central Park in the season that makes the city most alive — the specific sensation of nature inside the most intense city on earth',
    ],
    lunch: [
      ...
      'the West Village lunch sensory world — candlelit interior warm, wine cold, cobblestone visible through the window, everything right',
      'a SoHo outdoor café table in full Manhattan midday — city sun on the cobblestone, cast-iron shadow, the creative class moving past',
    ],
    afternoon: [
      ...
      'the Central Park afternoon sensation in season — the city gone, nature present, the towers just visible at the edges as reminder',
      'Brooklyn Bridge Park wind off the Hudson with the full Manhattan skyline directly in front — the most powerful city view on earth',
    ],
    reset: [
      ...
      'the Tribeca loft in the pre-evening hour — the city sounds below softened, the interior cool and composed, the night still forming',
      'a Midtown hotel suite above the amber skyline in transition — the city warm gold outside, the interior gathering itself for what comes next',
    ],
    golden_hour: [
      ...
      'a Manhattan rooftop in amber golden hour — glass towers warm orange above, the whole grid turning gold, the city at its most extraordinary',
      'the Brooklyn Bridge Park sensation at golden hour — Hudson wind, amber grid behind, the full skyline warm in front at maximum cinematic power',
    ],
    dinner: [
      ...
      'the West Village candlelit dinner sensory world — flame close, wine cool, cobblestone night outside, the warmest dinner block in the city',
      'a rooftop dinner above the full lit Manhattan grid — the city below as ambient sound and light, the table composed above everything',
    ],
    evening: [
      ...
      'the Meatpacking after-dark sensory world — cobblestone underfoot, warm bar glow, the High Line above, creative New York at full power',
      'the Manhattan rooftop at full electric night — the city grid spread below as sound and light, the most powerful urban sensation on earth',
    ],
    night: [
      ...
      'the Tribeca loft at night — the city glow through cast-iron windows, the street below never fully quiet, the loft finally still',
      'a hotel suite high above the electric Manhattan grid at midnight — the city lit and audible below, the room above it quiet and complete',
    ],
  },
  ...
  atmospherePools: {
    wake: [
      ...
      'the specific Tribeca loft atmosphere at dawn — cast-iron frames, the street below silent, the city not yet itself',
      'a Midtown hotel suite above the grey-blue Manhattan grid in its last quiet moment before it demands everything',
    ],
    morning_refresh: [
      ...
      'the Tribeca loft bathroom atmosphere — clean surfaces, city morning through the glass, the grid still just waking',
      'the particular focus of a New York morning self-care moment before SoHo and Central Park begin their claims',
    ],
    getting_dressed: [
      ...
      'the Tribeca loft wardrobe atmosphere — open rails, brick and wood, city light, the whole day waiting to be entered',
      'the Midtown hotel suite dressing atmosphere with the full Manhattan skyline behind the glass as the backdrop',
    ],
    breakfast: [
      ...
      'the West Village café atmosphere on a cobblestone block — brownstone outside, coffee warm inside, New York not yet loud',
      'the Tribeca loft kitchen morning atmosphere — industrial quiet, grey city light, the grid just starting to hum below',
    ],
    late_morning: [
      ...
      'Upper East Side composed museum-district morning elegance on Madison Avenue',
      'the SoHo cast-iron district late morning — Prince Street, art world energy, the most creative outdoor space in any city',
      'Central Park in the season that makes it most alive — the city\'s impossible green interior in full atmospheric contrast',
    ],
    lunch: [
      ...
      'the West Village candlelit restaurant interior at midday — the warmth of the best neighborhood in the greatest city',
      'a SoHo outdoor café table on cobblestone with cast-iron architecture as the ambient backdrop all around',
    ],
    afternoon: [
      ...
      'Central Park in its most seasonally alive state — the impossible contrast of nature inside the Manhattan grid at full power',
      'Brooklyn Bridge Park with the full Manhattan skyline in the background — the most dramatic city view on earth as atmosphere',
    ],
    reset: [
      ...
      'the Tribeca loft in the still hour between the afternoon and the electric night — the city quieter, the interior composed',
      'a hotel suite above the skyline in the day\'s transition — the grid still warm amber outside, the interior already evening',
    ],
    golden_hour: [
      ...
      'a Manhattan rooftop above the full amber skyline — the most powerful city on earth at its most visually extraordinary',
      'Central Park turning amber at the edges with the towers visible and warm — the city\'s impossible beautiful moment',
    ],
    dinner: [
      ...
      'the specific West Village candlelit evening — cobblestone outside, warm interior, the best dinner block in the world',
      'a rooftop dinner table above the full lit Manhattan grid — the whole city as the dining room at full electric power',
    ],
    evening: [
      ...
      'the Meatpacking District cobblestone and the High Line above it after dark — creative energy at its most alive in the city',
      'a Manhattan rooftop bar above the full electric grid at full night — the city below at complete cinematic power',
    ],
    night: [
      ...
      'the Tribeca loft above a city that never fully goes dark — the grid glowing, the loft quiet, the day finally done',
      'a hotel penthouse suite above the full electric Manhattan night — the city still completely alive far below in silence',
    ],
  },
  ...
  bodyLanguagePools: {
    wake: [
      ...
      'slow morning turn toward the Tribeca loft cast-iron window — the city grey-blue below, the body still in the night',
      'lying still in Tribeca loft sheets as the pale Manhattan dawn moves through cast-iron frames onto white surfaces',
    ],
    morning_refresh: [
      ...
      'focused upright posture at a Tribeca loft mirror — precise, composed, the city morning visible at one edge',
      'relaxed post-shower stance in a minimal New York interior — deliberate, unhurried, the grid activating below',
    ],
    getting_dressed: [
      ...
      'standing still in front of a full-height Tribeca loft mirror — the city behind the glass, the look fully formed',
      'hip-shifted easy stance at the Midtown hotel wardrobe with the skyline visible through the glass behind',
    ],
    breakfast: [
      ...
      'seated at a West Village café table facing the cobblestone block — body open, coffee in both hands, the morning completely unhurried',
      'slow lean over a Tribeca loft kitchen table in grey city morning — elbows on the surface, the grid below barely awake',
    ],
    late_morning: [
      ...
      'walking SoHo cast-iron blocks with a long editorial stride — shoulders back, the creative class moving around, completely at ease',
      'moving through Central Park in the season that makes the city most alive — natural open posture, the city invisible around the trees',
    ],
    lunch: [
      ...
      'settled into a West Village candlelit interior table — one arm resting, body easy, the cobblestone street visible just beyond',
      'slight forward lean at a SoHo outdoor café table — the cast-iron architecture behind, the lunch in front, the posture entirely New York',
    ],
    afternoon: [
      ...
      'walking Central Park in the season that makes it most beautiful — stride open, the city completely forgotten for a moment',
      'standing at the Brooklyn Bridge Park waterfront with the full Manhattan skyline behind — weight settled, the most powerful urban view in front',
    ],
    reset: [
      ...
      'seated on a Tribeca loft sofa in the late afternoon — body quiet, the city below beginning to shift toward electric, the evening forming',
      'slow interior movement in a Midtown hotel suite above the amber skyline — measured, composed, preparing for the West Village dinner',
    ],
    golden_hour: [
      ...
      'leaning on a Manhattan rooftop railing above the full amber grid — weight forward, the entire skyline warm in front',
      'standing still at Central Park\'s southern edge as the towers turn amber — body fully upright, the city transforming around the posture',
    ],
    dinner: [
      ...
      'settled at a West Village candlelit table on the most beautiful block in New York — body composed, the warmth of the room all around',
      'slight forward lean above a rooftop dinner table with the lit Manhattan grid below — attentive, warm, the city entirely beneath',
    ],
    evening: [
      ...
      'moving through the Meatpacking District after dinner with a loose confident stride — cobblestone underfoot, the High Line above',
      'pausing on a Manhattan rooftop railing above the full electric grid — hip against the rail, completely still, the city below at full power',
    ],
    night: [
      ...
      'slow recline back onto a Tribeca loft sofa above the still-glowing grid — the day finally released, the city still lit below',
      'gentle private movement around a hotel suite bedroom above the electric Manhattan skyline — barefoot, completely unwound, the night done',
    ],
  },
  ...
  narrativeIntentPools: {
    wake: [
      ...
      'holding the Tribeca loft above the silent street grid before the city demands anything',
      'waking inside the most ambitious city on earth before it has asked anything of you yet',
    ],
    morning_refresh: [
      ...
      'using the Tribeca loft bathroom quiet to build the composure the city will test all day',
      'letting the minimal New York morning ritual become the only luxury the day begins with',
    ],
    getting_dressed: [
      ...
      'making the Tribeca loft wardrobe moment feel like the entire city is waiting to be entered',
      'choosing what version of New York to be before the SoHo streets and Central Park make their demands',
    ],
    breakfast: [
      ...
      'making the West Village café table on a cobblestone block feel like the only calm place in the greatest city',
      'treating the Tribeca loft kitchen morning as the last private act before New York takes over completely',
    ],
    late_morning: [
      ...
      'navigating SoHo cast-iron streets and Prince Street galleries with the ease of someone who truly lives this city',
      'moving through Central Park in any season as if the whole park was built as personal backdrop',
    ],
    lunch: [
      ...
      'making the West Village candlelit interior table feel like the quiet centre of the most alive city on earth',
      'turning a SoHo outdoor café seat on cobblestone into a private editorial moment in the most public city',
    ],
    afternoon: [
      ...
      'letting Central Park in its most alive season make the impossible happen — nature inside the grid',
      'turning the Brooklyn Bridge Park afternoon with the full skyline behind into the most cinematic city moment',
    ],
    reset: [
      ...
      'using the Tribeca loft quiet before the evening to become the version of herself the city deserves at night',
      'letting the hotel suite above the skyline become the composure the West Village dinner table will need',
    ],
    golden_hour: [
      ...
      'standing on a Manhattan rooftop above the full amber skyline as the city shifts from gold to electric',
      'arriving at the Brooklyn Bridge with the entire lit grid behind just as New York becomes something beyond a city',
    ],
    dinner: [
      ...
      'making the candlelit West Village dinner table on the most beautiful cobblestone block feel like arriving',
      'turning a rooftop dinner above the fully lit Manhattan grid into the visual peak of the entire New York day',
    ],
    evening: [
      ...
      'drifting from West Village dinner through Meatpacking into the night as if the city has no end',
      'letting the Manhattan rooftop above the full electric grid become the final scene the city was building toward',
    ],
    night: [
      ...
      'returning to the Tribeca loft above the still-glowing grid after the city gave everything it had',
      'letting the hotel penthouse above the full electric Manhattan skyline be the last beautiful image of the day',
    ],
  },
