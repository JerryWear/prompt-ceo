...
cameraPools: {
    arrival: [
      '35mm full-body arrival framing, gym entrance architecture receding behind',
      '50mm clean three-quarter approach shot, glass facade compressed behind',
      '85mm glass-reflection entry perspective, subject doubled in entrance glass',
    ],
    warmup: [
      '50mm medium athletic prep framing, mirror wall receding behind subject',
      '85mm mirror-side activation angle, gym floor depth dissolved behind',
      '35mm clean treadmill profile, equipment receding along wall behind',
    ],
    training: [
      '50mm cinematic medium gym floor framing, equipment depth behind subject',
      '85mm machine-side three-quarter angle, gym geometry compressed behind',
      '35mm cable-station side profile, mirror wall doubling depth behind',
    ],
    heavy_sets: [
      '35mm low rack-side power angle, barbell in sharp foreground',
      '50mm bar-level strength perspective, weight plates filling foreground',
      '85mm front-quarter heavy-lift framing, rack geometry compressed behind',
    ],
    pump: [
      '85mm mirror-adjacent body emphasis, gym depth dissolved behind subject',
      '135mm tight upper-body detail angle, mirror reflection as background',
      '85mm post-set close three-quarter, pumped muscle catching gym light',
    ],
    posing: [
      '50mm straight-on mirror composition, reflection at same focal plane',
      '85mm side-angle body-check framing, mirror doubling subject in background',
      '35mm full-body physique display, mirror wall filling entire background',
    ],
    post_training: [
      '85mm bench-side recovery framing, gym depth soft behind subject',
      '50mm soft locker-room portrait, vanity light defining subject edge',
      '85mm mirror-side post-lift detail, reflection in sharp background',
    ],
    exit: [
      '35mm rear three-quarter departure, glass door receding ahead of subject',
      '50mm city-lit walkout framing, urban depth behind departing subject',
      '85mm duffel-on-shoulder departure, gym entrance dissolving behind',
    ],
    lifestyle: [
      '50mm terrace lifestyle portrait, city or rooftop depth behind subject',
      '35mm urban athleisure walk shot, city architecture receding behind',
      '85mm smoothie-bar body-lifestyle, interior depth compressed behind subject',
    ],
    night: [
      '85mm moody mirror composition, gym darkness surrounding subject',
      '50mm night terrace profile, city lights bokeh filling background',
      '135mm dark luxury locker portrait, single source in surrounding dark',
    ],
  },

  lightingPools: {
    arrival: [
      'clean 5500K natural daylight at entrance, glass facade adding secondary fill',
      'soft 4800K premium interior reception light, branded gym sources overhead',
      'late-day 3200K golden exterior glow, warm light raking across entrance',
    ],
    warmup: [
      'neutral 5000K gym light, overhead sources providing even body definition',
      'clean 5200K bright prep-zone light, mirror wall reflecting all sources',
      'controlled 4800K overhead lighting, polished floor multiplying fill',
    ],
    training: [
      'bright 5000K elite gym lighting, overhead sources defining physique cleanly',
      'controlled 5200K performance light across machines and mirrors',
      'premium 4800K overhead light, muscle lines visible under direct source',
    ],
    heavy_sets: [
      'harder 5500K directional gym light, stronger contrast on heavy-lift area',
      'serious 5200K strength-zone overhead, shadows deeper on muscle detail',
      'clean 5000K but slightly dramatic heavy-lift illumination, high contrast',
    ],
    pump: [
      'flattering 4800K mirror-side light, gym brightness sharpening muscle fullness',
      'post-set 5000K physique-defining gym light, warm tones rewarding effort',
      'slightly warmer 4600K reflective light, mirror multiplying warm fill',
    ],
    posing: [
      'mirror-reflected 5000K body-defining light, clean and controlled',
      'clean 5200K flattering lighting for physique checks, no harsh shadow',
      'controlled 4800K gym illumination, strong contour detail on muscle',
    ],
    post_training: [
      'softer 4000K recovery light, overhead sources dimmed in locker area',
      'warm 3800K locker-room vanity light, single directional source',
      'calm 3600K recovery-zone warm lighting, cool-down atmosphere',
    ],
    exit: [
      'sunset 3200K exterior glow, golden light raking across departure',
      'city-reflected 2800K evening light, urban sources as ambient fill',
      'clean 5200K glass-entry lighting, facade reflecting ambient city',
    ],
    lifestyle: [
      'sunlit 4800K terrace glow, city or rooftop providing open fill',
      'rooftop 4500K late-afternoon light, urban haze softening directional source',
      'luxury-club 5000K exterior daylight, polished surfaces adding secondary fill',
    ],
    night: [
      'moody 2800K low-key gym light, single source in surrounding darkness',
      'designer 2500K night-adjacent athletic lighting, warm and directional',
      'city-light 2700K reflections on glass and mirrors, ambient urban fill',
    ],
  },
