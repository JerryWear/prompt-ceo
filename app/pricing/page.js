...
const PLANS = [
  {
    ...
    features: [
      ...
      'Identity System™ — scan once, consistent across all content',
      '15 cinematic worlds — Monaco, Maldives, Bali, Paris, Dubai + more',
      ...
      'Perfect Day™ — 14 cinematic moments, morning to midnight',
  ...
  },
  {
    ...
    features: [
      ...
      'AI Director™ — natural language creative command center',
      'Life Engine™ — Creator Day, Travel World, Fitness Day, Ad Campaign Day',
      'Full Day Video™ — 12-scene cinematic production direction',
      'Full Ad Studio — Angles, Hooks (5 types), Captions, Images, Video, UGC',
      'Life Campaign Engine™ — 30-day schedule from the same daily arc',
  ...
  },
  {
    ...
    features: [
      ...
      'Full Life Campaign Orchestration Engine™ — all 5 day types',
      '5 retargeting angles auto-built from Life Campaign arc',
      'Platform versions — Instagram, TikTok, YouTube per campaign',
      'Performance Memory — tracks what works for your brand',
  ...
  },
  {
    ...
    features: [
      ...
      'Everything in Pro',
      'Unlimited Life Campaign Orchestration — all clients, all campaigns',
      'AI Director™ — multi-client creative briefing',
